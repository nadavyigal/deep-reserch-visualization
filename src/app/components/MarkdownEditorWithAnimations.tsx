...
interface MarkdownEditorWithAnimationsProps {
  markdown: string;
  onMarkdownChange: (markdown: string) => void;
}

const MarkdownEditorWithAnimations: React.FC<MarkdownEditorWithAnimationsProps> = ({
  markdown,
  onMarkdownChange,
}) => {
  ...
  const handleSampleMarkdown = () => {
    const sampleMarkdown = `# Markdown Animation Studio

## Introduction
This is a tool for creating animated visualizations from markdown content.

## How It Works
1. Write or paste your markdown in the editor
2. Select a section to animate
3. Click "Generate Animation" to create a visual representation

## Features
- Markdown editing and preview
- Section-based animation
- Code display for learning

## Examples
Try selecting different sections and generating animations to see how it works!
`;
...
export default MarkdownEditorWithAnimations; 